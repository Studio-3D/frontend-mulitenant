...
export default function ObjectifForm({ id = null }) {
    ...
    const fetchObjectif = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          reservations: objectif.reservations || { semaine: 0, mois: 0, jours: 0 }
        });
      } catch (error) {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm">
      <h2 className="text-xl font-semibold mb-6">{id ? "Modifier" : "Ajouter"} un objectif</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          ...
          {id ? (
            <input
              ...
              value={users.find(u => u.user_id === formData.user_id)?.user?.name + ' ' + users.find(u => u.user_id === formData.user_id)?.user?.prenom || 'Utilisateur non trouvé'}
              disabled
            />
          ) : (
            <div>
              ...
              {fetchingUsers && (
                <p className="mt-1 text-sm text-blue-500">Chargement des utilisateurs...</p>
              )}
            </div>
          )}
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-3 mb-6">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleMetricChange('visites', 'jours', e.target.value)}
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <input
                ...
                onChange={(e) => handleMetricChange('visites', 'semaine', e.target.value)}
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <input
                ...
                onChange={(e) => handleMetricChange('visites', 'mois', e.target.value)}
              />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-3 mb-6">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleMetricChange('appels', 'jours', e.target.value)}
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <input
                ...
                onChange={(e) => handleMetricChange('appels', 'semaine', e.target.value)}
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <input
                ...
                onChange={(e) => handleMetricChange('appels', 'mois', e.target.value)}
              />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-3 mb-6">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleMetricChange('reservations', 'jours', e.target.value)}
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <input
                ...
                onChange={(e) => handleMetricChange('reservations', 'semaine', e.target.value)}
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <input
                ...
                onChange={(e) => handleMetricChange('reservations', 'mois', e.target.value)}
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end gap-3 mt-8">
          <button
            type="button"
            onClick={() => router.push('/Administration/Objectifs')}
