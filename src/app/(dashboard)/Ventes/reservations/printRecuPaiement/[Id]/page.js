        ...
        <div className="p-4">
          ...
          <div className="pl-2">
            ...
            <p className="mb-4">
              ...
              <strong>
                {selectedProjet?.nbre_immeubles != 0 &&
                  `de l'immeuble  «${formValues.immeuble}»`}
              </strong>
              &nbsp;,
              <strong>
                {formValues.etage != 0
              ...
              <strong>{formValues.propriete_dite_bien}</strong> numéro{' '}
              <strong>{formValues.numero}</strong> situé à{' '}
              <strong>{formValues.adresse_projet}</strong> , consistant{' '}
              <strong>{formValues.type}</strong>
              en copropriété à usage {"d'"}habitation {"d'"}une superficie
              approximative de{' '}
              ...
              en futur {"d'"}achèvement, faisant {"l'"}objet {"d'"}un titre
            ...
            <p className="mb-4 font-bold">
              ...
              &nbsp;
              <span className="font-bold text-red-500">DIRHAMS</span>.
            </p>
