  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      raison_sociale: Yup.string()
        .required('Raison sociale est obligatoire')
        .min(3, 'Raison sociale doit contenir au moins 3 caractères'),
      nom_contact: Yup.string()
        .required('Nom est obligatoire')
        .min(3, 'Nom doit contenir au moins 3 caractères'),
      prenom_contact: Yup.string()
  ...
  return (
    <div className="bg-gradient-to-br from-white to-blue-50 w-full mt-2 min-h-[89vh] shadow-md rounded-lg p-12 relative overflow-hidden">
      ...
      <form
        ...
        className="grid xl:grid-cols-[500px_1fr] gap-12"
      >
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              />
              {formik.touched.prenom_contact &&
                formik.errors.prenom_contact && (
                  <p className="text-red-500 text-xs mt-1">
                    {formik.errors.prenom_contact}
                  </p>
                )}
            ...
            <div className="col-span-2">
              ...
              <input
                ...
                onBlur={formik.handleBlur}
                className={`w-full px-4 py-3 border ${
                  formik.touched.registre_commerce &&
                  formik.errors.registre_commerce
                    ? 'border-red-500 focus:ring-red-500'
                    : 'border-gray-200 focus:ring-blue-500'
                } rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-shadow duration-200`}
              />
