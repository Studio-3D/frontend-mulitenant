...
export const LeftCard = ({ tranche, onEdit, onDelete, canEdit = false }) => {
  ...
  const visibleStats = [showBiens, showImmeubles, showBlocs].filter(
    Boolean
  ).length;
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 gap-2 text-sm mt-6">
            <div className="flex items-center justify-between border-b border-gray-100 pb-2">
              ...
              <div className="text-gray-600 text-right">
                {(tranche?.date_lancement &&
                  new Date(tranche?.date_lancement).toLocaleDateString(
                    'fr-FR'
                  )) ||
                  'Date non spécifiée'}
              </div>
            ...
            <div className="flex items-center justify-between border-b border-gray-100 pb-2">
              ...
              <div className="text-gray-600 text-right">
                {(tranche?.date_livraison &&
                  new Date(tranche?.date_livraison).toLocaleDateString(
                    'fr-FR'
                  )) ||
                  'Date non spécifiée'}
              </div>
            ...
            <div className="flex items-center justify-between border-b border-gray-100 pb-2">
              ...
              <div className="text-gray-600 text-right">
                {tranche?.niveau_etages || 'Titre non spécifié'}
              </div>
            </div>
