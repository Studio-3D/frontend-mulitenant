...
const immeubleId = searchParams.get("immeuble");
  ...
  useEffect(() => {
    ...
    if (!id) {
      ...
      if (projet.nbre_tranches === 0 && projet.nbre_blocs !== 0 && !blocId && !immeubleId && !formData.bloc_id) {
      ...
      if (
        ...
        fetchDataByProjet_params('immeubles', setImmeubles, setLoadingImmeubles);
      }
     ...
     /*  if (projet.nbre_tranches !== 0 && projet.nbre_blocs !== 0 && !blocId && trancheId) {
      ...
      if (projet.nbre_blocs !== 0 &&(formData.tranche_id||trancheId) && !blocId ) {
          fetchDataByProjet_params('blocs', setBlocs, setLoadingBlocs,{ tranche_id: formData.tranche_id? formData.tranche_id : trancheId });
      } 
      if (projet.nbre_tranches !== 0&&projet.nbre_immeubles!=0 &&(formData.tranche_id||trancheId)&&projet.nbre_blocs==0 && !immeubleId ) {
          fetchDataByProjet_params('immeubles', setImmeubles, setLoadingBlocs,{ tranche_id: formData.tranche_id? formData.tranche_id : trancheId  });
      }
      if (projet.nbre_blocs !== 0&&projet.nbre_immeubles!=0 &&(formData.bloc_id||blocId) && !immeubleId) {
          fetchDataByProjet_params('immeubles', setImmeubles, setLoadingBlocs,{ bloc_id: formData.bloc_id? formData.bloc_id : blocId  });
      } 
  ...
  }, [blocId, immeubleId,trancheId,id,formData.bloc_id,formData.tranche_id,formData.immeuble_id]);
...
const validateStep0 = () => {
  ...
  if (formData.prix_unitaire == null) { // teste null ou undefined
...
const onSubmit_comp = () => {
  ...
  if (allZero) {
    setCompositionModalMessage("Veuillez renseigner la composition du bien avant de continuer.");
    setShowCompositionModal(true);
    return;
  }
              ...
              {!id &&
                ...
                !immeubleId ? (
                  <Grid item xs={12} sm={4}>
                    <Input label='Bloc' placeholder="Veuillez d'abord sélectionner un tranche" value={selectedBloc?.nom} fullWidth size='small' variant='outlined' disabled={true} />
                  </Grid>
                  ...
                  <InputSelect
                   ...
                   required
                 />
                ) : projet.nbre_tranches === 0 && projet.nbre_blocs !== 0 && !blocId && !immeubleId ? (
                  <InputSelect
                   label="Bloc"
                   options={blocs.map(t => ({ label: t.nom, value: t.id }))}
                   value={formData.bloc_id}
              ...
              {!id &&
                ...
                !immeubleId ? (
                  ...
                  <InputSelect
                    ...
                    onChange={(option) => handleselectChange("immeuble_id", option?.value || null)}
                  ...
                  !immeubleId ? (
                    <Input
                      label='Immeuble'
                      placeholder="Veuillez d'abord sélectionner un tranche"
                      value={selectedImmeuble?.nom}
                      fullWidth
                      size='small'
                      variant='outlined'
  ...
  <div className="bg-white p-6 rounded-md shadow-sm">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <Input
        ...
        onChange={(e) => handleChange("nbre_chambres", e.target.value, "comp")}
      />
      ...
      <Input
        ...
        onChange={(e) => handleChange("nbre_cuisines", e.target.value, "comp")}
      />
      ...
      <Input
        ...
        onChange={(e) => handleChange("nbre_terasses", e.target.value, "comp")}
      />
      ...
      <Input
        ...
        onChange={(e) => handleChange("nbre_receptions", e.target.value, "comp")}
      />
      ...
      <Input
        ...
        onChange={(e) => handleChange("nbre_buanderies", e.target.value, "comp")}
      />
