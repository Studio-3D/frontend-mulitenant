...
// In ProjectDetailsPage.js, update STATUS_CONFIG to use your enum
const STATUS_CONFIG = {
      ...
      <div className="flex flex-col lg:flex-row gap-6 h-full">
        ...
        <div className="w-full lg:w-2/3">
          <RightCard
            ...
            blocs={projectData?.projet?.bloc}
            immeubles={projectData?.projet?.immeuble}
            typologies={projectData?.projet?.typologies || []}
            vues={projectData?.projet?.vues || []}
            typeBiens={projectData?.projet?.types_bien || []}
          />
        </div>
      </div>
